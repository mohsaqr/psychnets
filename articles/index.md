...
- [Stepwise Gaussian graphical model
  selection](https://pak.dynasite.org/psychnets/articles/ggm-model-selection.md):
- [Regulation networks from Dynalytics event
  data](https://pak.dynasite.org/psychnets/articles/group-networks-from-event-data.md):
- [Information-filtering networks with TMFG and
